          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <motion.div whileHover={{ scale: 1.02 }} className="group relative bg-[#0a0a0a] border border-white/5 p-12 overflow-hidden min-h-[450px] flex flex-col justify-end">
              ...
              <div className="relative z-20">
                ...
                <Link to="/traditions" className="font-display font-black text-bai-red uppercase tracking-widest text-xs border-b border-bai-red pb-1">Learn More</Link>
              </div>
            </motion.div>
            ...
            <motion.div whileHover={{ scale: 1.02 }} className="group relative bg-[#0a0a0a] border border-white/5 p-12 overflow-hidden min-h-[450px] flex flex-col justify-end">
              ...
              <div className="relative z-20">
                ...
                <Link to="/tour" className="font-display font-black text-bai-blue uppercase tracking-widest text-xs border-b border-bai-blue pb-1">Get Tickets</Link>
              </div>
            </motion.div>
          </div>
        </div>
